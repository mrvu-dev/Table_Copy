...
const _TCAP_CONFIG = {
  ...
  api: {
    ...
    cloud: {
      signup: `${BASE_API_URL}/licensing/charge/cloudsignup`,
      licenses: `${BASE_API_URL}/licensing/charge/user/cloudlicenses`,
      capturedefinition: `${BASE_API_URL}/cloud/capturedefinition`,
    },
  ...
  // Referral links:
  duneExtension:
    "https://chrome.google.com/webstore/detail/dune-data-extractor-by-ta/najiannhbfegmjhgkgikhpdefhnfdbmc",
  zillowExtension:
...
const _TC_OAUTH_IDS = {
  ...
  // Note: This is using this Extension IDL: eifjgiapiamkhboaohchdlfldmdcdekj
  dev_b:
...
// NOTE(gmike): These aren't used anywhere.
