class BrowserEnv {
  ...
  bindToCopy() {
    Array.from(document.querySelectorAll("a.ext-chrome-home")).forEach((el) => {
      el.addEventListener("click", () => {
        // Chrome:
        this.createTab({ url: "chrome://extensions" });

        // Edge:
        // this.createTab({ url: "edge://extensions" });
      });
    });
    Array.from(document.querySelectorAll("a.ext-keyboard-shortcuts")).forEach(
      (el) => {
        el.addEventListener("click", () => {
          // Chrome:
          ...
          // Edge:
          // this.createTab({ url: "edge://extensions/shortcuts" });
        });
      }
    );
  }
